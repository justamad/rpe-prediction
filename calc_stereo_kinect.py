...
from rpe_prediction.processing import apply_butterworth_df
...
cam.calculate_affine_transform_based_on_data(show=False)
...
f_avg = apply_butterworth_df(avg, sampling_frequency=30, order=4, fc=6)
